...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-doc" id="list-doc-list"  role="tab"    aria-controls="home" data-toggle="list">Hospital List</a>
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list"  role="tab" data-toggle="list" aria-controls="home">RTPCR Test List</a>
                ...
                <div class="col-sm-4" style="left: 13%;margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">RTPCR Test List</h4>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      <option value="head" name="spec" disabled selected>Select State</option>
                      <option value="Delhi" name="spec">Delhi</option>
                      <option value="Maharashtra" name="spec"> Maharashtra</option>
                      <option value="MP" name="spec">MP</option>
                      <option value="Punjab" name="spec">Punjab</option>
                      <option value="UP" name="spec"> UP</option>
                    </select>
                    </div><br><br>
      ...
      <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <input type="submit" name="docsub1" value="Delete Hospital" class="btn btn-primary" onclick="confirm('do you really want to delete?')">
        </form>
      </div>
